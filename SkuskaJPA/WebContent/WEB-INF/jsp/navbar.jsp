...
<body>
	...
	<div class="navbar navbar-default navbar-static-top" role="navigation">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="games?action=play&name=${game.getGameName()}">${game.getGameName()}</a></li>
		...
		<ul class="nav navbar-nav pull-right">
			<c:choose>
				<c:when test="${sessionScope.user!=null}">
					<li><a href="logoutUser"><span class="glyphicon glyphicon-user"></span> ${sessionScope.user }</a></li>
